...
namespace ChaincoinX.Networks.Deployments
{
   /// <summary>
   /// BIP9 deployments for the Blockcore sample coin network.
   /// </summary>
   public class ChaincoinXBIP9Deployments : BIP9DeploymentsArray
   {
      ...
      /// </summary>
      public ChaincoinXBIP9Deployments() : base(NumberOfDeployments)
      {
      }
