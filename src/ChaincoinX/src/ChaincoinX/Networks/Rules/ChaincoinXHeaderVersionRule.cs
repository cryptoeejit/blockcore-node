...
namespace ChaincoinX.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="ChaincoinXMain"/> network block's header has a valid block version.
   /// </summary>
   public class ChaincoinXHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
