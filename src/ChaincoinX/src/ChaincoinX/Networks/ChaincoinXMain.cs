...
using ChaincoinX.Networks.Policies;
using ChaincoinX.Networks.Rules;
using NBitcoin;
...
using ChaincoinX.Networks.Deployments;

namespace ChaincoinX.Networks
{
   public class ChaincoinXMain : Network
   {
      public ChaincoinXMain()
      {
         CoinSetup setup = ChaincoinXSetup.Instance.Setup;
         NetworkSetup network = ChaincoinXSetup.Instance.Main;

         NetworkType = NetworkType.Mainnet;
         DefaultConfigFilename = setup.ConfigFileName; // The default name used for the ChaincoinX configuration file.
         ...
         var bip9Deployments = new ChaincoinXBIP9Deployments()
         {
            [ChaincoinXBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
         ...
         {
            PosEmptyCoinbase = ChaincoinXSetup.Instance.IsPoSv3(),
            PosUseTimeFieldInKernalHash = ChaincoinXSetup.Instance.IsPoSv3()
         };
         ...
         StandardScriptsRegistry = new ChaincoinXStandardScriptsRegistry();
      ...
      protected void RegisterRules(IConsensus consensus)
      {
         consensus.ConsensusRules
             ...
             .Register<ChaincoinXHeaderVersionRule>()
