...
namespace Chaincoin.Networks.Deployments
{
   /// <summary>
   /// BIP9 deployments for the Blockcore sample coin network.
   /// </summary>
   public class ChaincoinBIP9Deployments : BIP9DeploymentsArray
   {
      ...
      /// </summary>
      public ChaincoinBIP9Deployments() : base(NumberOfDeployments)
      {
      }
