...
namespace Dash.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="DashMain"/> network block's header has a valid block version.
   /// </summary>
   public class DashHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
